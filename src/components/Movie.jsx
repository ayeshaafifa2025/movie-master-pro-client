...
const Movie = ({movie}) => {
    console.log(movie);
    const{_id,posterUrl,title,rating,director,
language
}=movie;
    return (
      ...
      <div className="px-6 py-4">
        ...
        <p className="text-gray-900 font-semibold mb-1">Director Name:{movie.director
}</p>
...
language}</p>
        ...
        >
            <Link to={`/movies/movie-details/${_id}`}>View Details</Link> 
